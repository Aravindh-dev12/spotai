    ...
    <SafeAreaView style={{ flex: 1 }}>
      <ScrollView contentContainerStyle={{ padding: 24, gap: 18 }}>
        ...
        <TextInput
          ...
          multiline
          placeholder="Example: I went to a new place with two friends instead of staying home."
          style={{ minHeight: 130, borderWidth: 1, borderRadius: 16, padding: 16, textAlignVertical: 'top', fontSize: 17 }}
        />
        ...
        {state ? (
          <View style={{ marginTop: 18, gap: 10 }}>
            ...
            <View style={{ height: 10, borderWidth: 1, borderRadius: 99, overflow: 'hidden' }}>
              <View style={{ height: '100%', width: `${state.awakeningProgress}%`, backgroundColor: '#111' }} />
            </View>
